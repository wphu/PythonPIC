...
s = laser("field_only", 0, impulse_duration, 1e21, 0).lazy_run()
...
s = laser("production_run_23_01", n_macroparticles, impulse_duration, 1e23, 0.01).lazy_run()
plots(s, *args, frames="all")
s = laser("production_run_21_4", n_macroparticles, impulse_duration, 1e21, 0.4).lazy_run()
plots(s, *args, frames="all")
...
plots(s, *args, frames="all")
s = laser("production_run_nolaser_01", n_macroparticles, impulse_duration, 0, 0.01).lazy_run()
plots(s, *args, frames="all")
