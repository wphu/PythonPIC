...
energy_axes.semilogy(np.arange(S.NT),(S.kinetic_energy), "o-", label="Kinetic energy")
energy_axes.semilogy(np.arange(S.NT),(S.field_energy), "o-", label="Field energy")
energy_axes.semilogy(np.arange(S.NT),(S.total_energy), "o-", label="Total energy")
